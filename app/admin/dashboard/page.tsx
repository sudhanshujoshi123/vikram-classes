      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          ...
          {filteredStudents.map(s => (
            ...
            >
              <td className="p-4 font-semibold">{s.name}</td>
              <td className="p-4">{s.student_class}</td>

              <td className="p-4">
                <input
                  type="number"
                  className="w-28 border rounded-lg px-3 py-1"
                  value={amounts[s.id] ?? ''}
                  onChange={e =>
                    setAmounts({
                      ...amounts,
              ...
              <td className="p-4">
                <button
                  ...
                  text-white px-5 py-1.5 rounded-lg font-semibold"
                >
                  Save
                </button>
              </td>
